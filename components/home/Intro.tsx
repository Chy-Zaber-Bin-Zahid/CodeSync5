      ...
      <div className="w-full px-3 pt-4">
        <div className='mx-auto max-w-big-screen w-full flex gap-4 justify-between items-center'>
          <div id="intro-text" className='flex flex-col gap-3 justify-center items-start w-[60%]' >
            ...
            <button onClick={() => setToggleModal(true)} className='bg-gray-500 font-semibold hover:bg-gray-700 transition-all duration-300 text-white p-2 rounded animate-bounce flex gap-2 justify-center items-center' > <CalendarCheck size={18} weight="fill" />BOOK US</button>
          </div>

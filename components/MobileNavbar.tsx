...
function MobileNavbar({ toggleNav, setToggleNav }: MobileNavbar) {
  ...
  const baseLinkCommonClass =
    "transition-all duration-300 no-underline border-b-2 pr-[4px]";
  ...
  return (
    <div
      className={`absolute top-0 right-0 z-50 bg-white h-screen w-3/4 border-l border-gray-300 py-3 px-4 transition-all duration-500 min-mq-766:hidden mq-765:block ${
